  ...
  export default {
    ...
    methods: {
      ...
      obtenerSolicitudes() {
        ...
        const url = 'http://localhost:3000/api/certificaciones/getSolicitud';
        const data = 
        { 
            idUsuario: 1234567890123,
            idUsuarioEmpleado: 0,
            idSolicitud: 0
         };
      ...
      verSolicitud(solicitud) {
        ...
        this.$router.push({
            path: `/seguimientoSolicitud`, // Asegúrate de que coincide con la ruta en el router
            query: { Solicitud: solicitud },
        });
